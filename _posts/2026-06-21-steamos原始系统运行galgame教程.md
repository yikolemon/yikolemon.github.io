...
5. 将游戏目录下的dll文件添加进启动参数中（无法启动/闪退 使用）
    - 添加方式：`LANG=zh_CN.UTF-8 LC_ALL=zh_CN.UTF-8 LC_CTYPE=zh_CN.UTF-8 LC_MESSAGES=zh_CN.UTF-8 LANGUAGE=zh_CN WINEDLLOVERRIDES="emotedriver.dll=n" %command%`
    - 多个dll：`WINEDLLOVERRIDES="a.dll=n;b.dll=n;c.dll=n"` 使用;分隔
...
**对于动画/OP/ED的播放问题，如果你有好的解决方案，可以在视频评论区留言，造福更多玩家，感谢**
